$(function() {
    ...
    for( j = 0, k = orderList.length; j < k; j++) {
        $itemList.append(
            ...
            + "</label></span><a href='#' class='lnkClose'>[X]</a></li>"
        );
    }
    ...
    $.subscribe('/add/', function() {
        if ($newTodo.val() !== "") {
            ...
            console.log("+ Added flight " + items, i);
    ...
    $.subscribe('/remove/', function($this) {
        ...
        console.log("- Removed flight " + parentId);
